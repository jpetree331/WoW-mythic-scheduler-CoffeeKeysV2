...
const TankIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M12.75 2.25a.75.75 0 01.75.75v5.25a.75.75 0 01-1.5 0V3.41L4.22 10.94a2.25 2.25 0 00-.82 1.63V21a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75v-8.43c0-.65-.28-1.26-.74-1.68L13.5 3.41V8.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75z" clipRule="evenodd" />
